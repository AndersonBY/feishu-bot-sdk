...
class ChatService:
    ...
    def get_chat(self, chat_id: str, *, user_id_type: Optional[str] = None) -> Mapping[str, Any]:
        response = self._client.request_json(
            "GET",
    ...
    def list_chats(
        ...
        *,
        ...
        response = self._client.request_json("GET", "/im/v1/chats", params=params)
        return _unwrap_data(response)
    ...
    def search_chats(
        ...
        *,
        ...
        response = self._client.request_json("GET", "/im/v1/chats/search", params=params)
        return _unwrap_data(response)

    def iter_search_chats(
        self,
        query: str,
        *,
        user_id_type: Optional[str] = None,
    ...
    def put_top_notice(self, chat_id: str, notice: Mapping[str, object]) -> Mapping[str, Any]:
        response = self._client.request_json(
            "POST",
    ...
    def delete_top_notice(self, chat_id: str) -> Mapping[str, Any]:
        response = self._client.request_json(
            "POST",
    ...
    def delete_chat(self, chat_id: str) -> Mapping[str, Any]:
        response = self._client.request_json("DELETE", f"/im/v1/chats/{chat_id}")
        return _unwrap_data(response)
    ...
    def join_chat(self, chat_id: str) -> Mapping[str, Any]:
        response = self._client.request_json("PATCH", f"/im/v1/chats/{chat_id}/members/me_join")
        return _unwrap_data(response)
    ...
    def check_in_chat(self, chat_id: str) -> Mapping[str, Any]:
        response = self._client.request_json("GET", f"/im/v1/chats/{chat_id}/members/is_in_chat")
        return _unwrap_data(response)
    ...
    def iter_announcement_blocks(
        ...
        *,
        ...
        page_token: Optional[str] = None
        while True:
            data = self.list_announcement_blocks(
                chat_id,
                revision_id=revision_id,
                user_id_type=user_id_type,
                page_size=page_size,
    ...
    def list_announcement_children(
        self,
        chat_id: str,
        block_id: str,
        *,
    ...
    def iter_announcement_children(
        self,
        chat_id: str,
        block_id: str,
        *,
        ...
        page_token: Optional[str] = None
        while True:
            data = self.list_announcement_children(
                chat_id,
                block_id,
                revision_id=revision_id,
                user_id_type=user_id_type,
    ...
    def create_announcement_children(
        self,
        chat_id: str,
        block_id: str,
    ...
    def batch_update_announcement_blocks(
        self,
        chat_id: str,
    ...
    def delete_announcement_children(
        self,
        chat_id: str,
        block_id: str,
    ...
    def create_tabs(self, chat_id: str, tabs: Sequence[Mapping[str, object]]) -> Mapping[str, Any]:
        response = self._client.request_json(
            "POST",
    ...
    def update_tabs(self, chat_id: str, tabs: Sequence[Mapping[str, object]]) -> Mapping[str, Any]:
        response = self._client.request_json(
            "POST",
    ...
    def sort_tabs(self, chat_id: str, tab_ids: Sequence[str]) -> Mapping[str, Any]:
        response = self._client.request_json(
            "POST",
    ...
    def list_tabs(self, chat_id: str) -> Mapping[str, Any]:
        response = self._client.request_json("GET", f"/im/v1/chats/{chat_id}/chat_tabs/list_tabs")
        return _unwrap_data(response)

    def delete_tabs(self, chat_id: str, tab_ids: Sequence[str]) -> Mapping[str, Any]:
        response = self._client.request_json(
            "DELETE",
    ...
    def create_menu(self, chat_id: str, menu_tree: Mapping[str, object]) -> Mapping[str, Any]:
        response = self._client.request_json(
            "POST",
    ...
    def get_menu(self, chat_id: str) -> Mapping[str, Any]:
        response = self._client.request_json("GET", f"/im/v1/chats/{chat_id}/menu_tree")
        return _unwrap_data(response)
    ...
    def sort_menu(self, chat_id: str, top_level_ids: Sequence[str]) -> Mapping[str, Any]:
        response = self._client.request_json(
            "POST",
    ...
    def delete_menu(self, chat_id: str, top_level_ids: Sequence[str]) -> Mapping[str, Any]:
        response = self._client.request_json(
            "DELETE",
            f"/im/v1/chats/{chat_id}/menu_tree",
            payload={"chat_menu_top_level_ids": _normalize_ids(top_level_ids, name="top_level_ids")},
