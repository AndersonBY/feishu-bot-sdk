# feishu-bot-sdk Docs (English)

[中文版](./README.md)

This directory contains module-based SDK documentation. Each module has a standalone page so you can jump directly to the part you need.
