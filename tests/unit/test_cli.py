...
def test_im_send_text_json_output_handles_struct_in_dataclass(monkeypatch: Any, capsys: Any) -> None:
    monkeypatch.setenv("FEISHU_APP_ID", "cli_test_app")
    monkeypatch.setenv("FEISHU_APP_SECRET", "cli_test_secret")
...
def test_im_send_text_human_output_handles_struct_in_dataclass(monkeypatch: Any, capsys: Any) -> None:
    monkeypatch.setenv("FEISHU_APP_ID", "cli_test_app")
    monkeypatch.setenv("FEISHU_APP_SECRET", "cli_test_secret")
...
def test_media_download_file_image_key_uses_image_endpoint(monkeypatch: Any, tmp_path: Path, capsys: Any) -> None:
    monkeypatch.setenv("FEISHU_APP_ID", "cli_test_app")
    monkeypatch.setenv("FEISHU_APP_SECRET", "cli_test_secret")
    ...
    monkeypatch.setattr("feishu_bot_sdk.im.media.MediaService.download_image", _fake_download_image)
...
def test_media_download_file_message_resource(monkeypatch: Any, tmp_path: Path, capsys: Any) -> None:
    monkeypatch.setenv("FEISHU_APP_ID", "cli_test_app")
    monkeypatch.setenv("FEISHU_APP_SECRET", "cli_test_secret")
...
def test_media_download_file_resource_type_requires_message_id(monkeypatch: Any, capsys: Any) -> None:
    monkeypatch.setenv("FEISHU_APP_ID", "cli_test_app")
    monkeypatch.setenv("FEISHU_APP_SECRET", "cli_test_secret")
...
def test_search_app(monkeypatch: Any, capsys: Any) -> None:
    ...
    monkeypatch.setattr("feishu_bot_sdk.search.SearchService.search_apps", _fake_search_apps)
...
def test_search_app_all(monkeypatch: Any, capsys: Any) -> None:
    ...
    code = cli.main(["search", "app", "--query", "calendar", "--all", "--format", "json"])
    assert code == 0
    assert calls == [None, "next_1"]
    payload = json.loads(capsys.readouterr().out)
    assert payload["all"] is True
...
def test_search_message(monkeypatch: Any, capsys: Any) -> None:
    ...
    monkeypatch.setattr("feishu_bot_sdk.search.SearchService.search_messages", _fake_search_messages)
...
def test_search_doc_wiki(monkeypatch: Any, capsys: Any) -> None:
    ...
    monkeypatch.setattr("feishu_bot_sdk.search.SearchService.search_doc_wiki", _fake_search_doc_wiki)
...
def test_search_defaults_to_user_auth_even_when_env_tenant(monkeypatch: Any, capsys: Any) -> None:
...
def test_contact_user_batch_get(monkeypatch: Any, capsys: Any) -> None:
    ...
    monkeypatch.setattr("feishu_bot_sdk.contact.ContactService.batch_get_users", _fake_batch_get_users)
...
def test_contact_user_get_id_requires_email_or_mobile(monkeypatch: Any, capsys: Any) -> None:
    monkeypatch.setenv("FEISHU_APP_ID", "cli_test_app")
    monkeypatch.setenv("FEISHU_APP_SECRET", "cli_test_secret")
...
def test_contact_user_get_id(monkeypatch: Any, capsys: Any) -> None:
    ...
    monkeypatch.setattr("feishu_bot_sdk.contact.ContactService.batch_get_user_ids", _fake_batch_get_user_ids)
...
def test_contact_scope_get(monkeypatch: Any, capsys: Any) -> None:
    ...
    monkeypatch.setattr("feishu_bot_sdk.contact.ContactService.list_scopes", _fake_list_scopes)
...
def test_format_feishu_error_message_token_hints() -> None:
    invalid_access = cli._format_feishu_error_message("feishu api failed: {'code': 20005, 'msg': 'invalid access token'}")
    assert "re-login" in invalid_access

    invalid_refresh = cli._format_feishu_error_message("feishu api failed: {'code': 20026, 'msg': 'refresh token is invalid'}")
...
def test_cli_main_feishu_error_uses_hint(monkeypatch: Any, capsys: Any) -> None:
    ...
    def _fake_get_info(_self: BotService) -> Any:
        raise FeishuError("feishu api failed: {'code': 20026, 'msg': 'refresh token is invalid'}")
